...
function tebak(event) {
  ...
  if (
    music.src == "https://luthfimhmn.github.io/music/kopdut_question.mp3" &&
    response.toLowerCase() == realAnswer[0]
  ) {
    ...
    music.src == "https://luthfimhmn.github.io/music/lazy_question.mp3" &&
    response.toLowerCase() == realAnswer[1]
  ) {
    ...
    music.src == "https://luthfimhmn.github.io/music/lemontree_question.mp3" &&
    response.toLowerCase() == realAnswer[2]
  ) {
    // masukan class hide jadi available
    hasil.innerText = "Anda Benar!!";
    hasil.setAttribute("class", "muncul");
