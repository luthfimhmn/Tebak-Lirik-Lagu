...
function tebak(event) {
    ...
    // if(response.toLowerCase() == realAnswer[0] &&  arrPictQuestion[0]){
    ...
    // }else if(response.toLowerCase() == realAnswer[1] && arrPictQuestion[1]){
    //         // masukan class hide jadi available
    //         hasil.innerText = "Anda Benar!!"
    //         hasil.setAttribute("class","muncul");
    //         bersih()
    ...
    // }else if (response.toLowerCase() == realAnswer[2] && arrPictQuestion[2]){
    //         // masukan class hide jadi available
    //         hasil.innerText = "Anda Benar!!"
    //         hasil.setAttribute("class","muncul");
    //         bersih()
